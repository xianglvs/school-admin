...
<el-form   ref="rowRecord"  label-width="100px" :rules="rules" :model="rowRecord" style="max-width:500px;overflow:auto;">
          ...
          <el-form-item  label="描述：" prop="description" >
            <el-input  v-model="rowRecord.description"    type="textarea" :autosize="{ minRows: 3, maxRows: 8}" ></el-input>
          </el-form-item>
          <el-form-item  label="排序：" prop="sort" >
            <el-input-number v-model="rowRecord" :min="0" :max="10000" ></el-input-number>
          </el-form-item>
    ...
    resetForm() {
     ...
     submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            let params = Object.assign({}, this.rowRecord);
            if(params.id){
                this.update(params);
            }else{
              this.add(params);
